...
<template>
  <main>
    ...
    <article class="relations">
      ...
      <CharacterRelations v-if="character.partners" relation-category="Partneři"
        :relation-content="character.partners" />
      <CharacterRelations v-if="character.siblings" relation-category="Sourozenci"
        :relation-content="character.siblings" />
    </article>
  </main>
</template>
